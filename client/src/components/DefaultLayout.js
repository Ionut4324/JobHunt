  ...
  render() {
    ...
    return (
      <Layout>
        ...
        >
          <div className="logo">
            {this.state.collapsed ? (<h1>JH</h1>) : (<h1>JobHunt</h1>)}
          </div>
          <Menu theme="dark" mode="inline" defaultSelectedKeys={[window.location.pathname]} style={{ backgroundColor: '#294660' }}>
        ...
        <Layout className="site-layout">
          <Header className="site-layout-background" style={{ padding: 0, position: 'sticky', overflow: 'auto', top: 0, zIndex: 9999 }}>
            ...
            <div className="flex justify-content-between">
              ...
              <div>
                <h1 >Looking for a job? Apply now!</h1>
              </div>
